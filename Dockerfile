...
ARG UPTRACE_VERSION
# See: https://github.com/ClickHouse/docker-library/blob/e0d01891a279d0c8c03d92255aa24734729e1edf/server/26.8.2.7/Dockerfile.alpine
ARG CLICKHOUSE_VERSION=26.8-alpine
...
ARG REDIS_VERSION=8-alpine

# -- Declare images --
FROM uptrace/uptrace:${UPTRACE_VERSION} AS uptrace
FROM clickhouse/clickhouse-server:${CLICKHOUSE_VERSION} AS clickhouse
